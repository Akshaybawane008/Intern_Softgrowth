...
import { Search, Filter, ChevronLeft, ChevronRight, Eye, Clock, Download, User } from "lucide-react";
    ...
    <div className="p-4">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-gray-800 to-amber-600 dark:from-white dark:to-amber-200 bg-clip-text text-transparent">
            In Progress Tasks
          </h1>
        </div>
        <p className="text-gray-600 dark:text-gray-400 text-sm">
          Monitor ongoing tasks and track progress
        </p>
      </div>
          ...
          {currentRecords.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
                All ongoing tasks will appear here
              </p>
            </div>
          ) : (
          ...
          <div className="border-t border-gray-200 dark:border-gray-600 p-3">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
              <div className="text-xs text-gray-600 dark:text-gray-400">
                ...
                {filteredTasks.length} in-progress tasks
              </div>
